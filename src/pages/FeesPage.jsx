    ...
    <Layout>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400">{MONTH_NAMES[selectedMonth - 1]} {selectedYear}</p>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100">
                    <th className="text-left text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Student</th>
                    <th className="text-left text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Class</th>
                    <th className="text-right text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Amount</th>
                    <th className="text-right text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Paid On</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  {paidStudents.map(s => (
                    <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-4 py-2.5 text-sm text-gray-500">{s.class || '—'}</td>
                      <td className="px-4 py-2.5 text-sm text-emerald-700 font-medium text-right">{formatCurrency(s.payment.amount)}</td>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100">
                    <th className="text-left text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Student</th>
                    <th className="text-left text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Class</th>
                    <th className="text-right text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Expected</th>
                    <th className="text-right text-xs font-medium text-gray-400 uppercase tracking-wider px-4 py-2.5">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  {unpaidStudents.map(s => (
                    <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-4 py-2.5 text-sm font-medium text-gray-900">{s.name}</td>
                      <td className="px-4 py-2.5 text-sm text-gray-500">{s.class || '—'}</td>
                      <td className="px-4 py-2.5 text-sm text-gray-700 font-medium text-right">{formatCurrency(s.monthly_fee)}</td>
